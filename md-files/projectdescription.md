...
The output of the application must include:
- an image of the Mandelbrot set in PNG format
- a text file with two columns: the grain size and the execution time obtained with that grain size
